...
extern const unsigned char _binary_assets_index_DNfZD3Cb_js_start[];
extern const unsigned char _binary_assets_index_DNfZD3Cb_js_end[];
...
cbm_embedded_file_t CBM_EMBEDDED_FILES[] = {
    ...
    {"/assets/index-DNfZD3Cb.js", _binary_assets_index_DNfZD3Cb_js_start, 0, "application/javascript"},
...
static void __attribute__((constructor)) init_embedded_sizes(void) {
    ...
    files[1].size = (unsigned int)(_binary_assets_index_DNfZD3Cb_js_end - _binary_assets_index_DNfZD3Cb_js_start);
